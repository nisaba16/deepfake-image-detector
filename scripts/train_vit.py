"""Training script for Vision Transformer deepfake detection.

This script trains a 6-channel ViT-B/16 model:
1. Uses SixChannelPreprocessor to generate 6-channel inputs
2. Trains DeepfakeViT end-to-end with PyTorch
...
from models.custom_vit import DeepfakeViT, export_to_onnx
...
def train_model(
    ...
    """Train the Vision Transformer model with learning rate scheduling.
    ...
    Args:
        ...
        label_smoothing: Label smoothing for better calibration (0.0-0.2, default: 0.2)
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train Vision Transformer (ViT-B/16) for deepfake detection')
...
def main():
    ...
    # Export to ONNX
    if args.export_onnx:
        onnx_path = output_dir / 'deepfake_vit.onnx'
